...
export default function DataTable() {
  ...
  const columns = [
    ...
    { field: 'transactionDate', headerName: 'Tanggal Penerimaan', width: 200 },
    { field: 'customer', headerName: 'Nasabah', width: 200 },
    { field: 'trashAmount', headerName: 'Total Sampah', width: 200, align: 'center', headerAlign: 'center' },
    { field: 'income', headerName: 'Harga Dibayar', width: 200, align: 'center', headerAlign: 'center' },
